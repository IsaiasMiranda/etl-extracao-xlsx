...
def main():
    ...
    base_dir = BASE_GERAL / 'base-siga-medicao/source/Medições'
    
    pasta_origem  = base_dir
    pasta_destino = BASE_GERAL / 'base-siga-medicao/base-consolidada'
    pasta_processada  = BASE_GERAL / 'base-siga-medicao/arquivo-processado'
